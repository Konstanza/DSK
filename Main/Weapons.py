...
class Weapon():
    ...
    def shoot(self, player):
        if self.count == 0:
            ...
            return Projectil(player, x,y,player.dirX,player.dirY, player.deg, self.shotImage.copy(),self.shotPower,self.shotSpeed)
        return None
...
class Projectil(pygame.sprite.Sprite):
    ...
    def __init__(self, player, x, y, dirX, dirY, deg, image, power, speed):
